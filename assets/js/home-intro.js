...
document.addEventListener("DOMContentLoaded", () => {
  ...
  .to(line4b, {
    ...
    onStart: () => { line4b.classList.add('intro-line-4b-outline'); }
  }, 1.3)
  // 1.5-2.5s: letter flip
  .to(letters, {
    rotationX: 180, duration: 0.14, ease: 'power2.inOut', stagger: 0.1
  }, 1.5)
  // 2.5-2.7s: return to filled
  .to(line4b, {
    duration: 0.25, ease: 'power2.inOut',
    onStart: () => { line4b.classList.remove('intro-line-4b-outline'); }
  }, 2.5)
  .to(letters, {
    rotationX: 0, duration: 0.15, ease: 'power2.inOut', stagger: 0.015
  }, 2.5)
  ...
  .to([line1, line2, line3, line4a, line4b], {
    ...
    duration: 0.8, ease: 'power2.in', stagger: 0.03
  }, 2.7)
  .to(introContainer, {
